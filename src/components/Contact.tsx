...
export const Contact = () => {
  ...
  return (
    <section className="contact" id="connect">
      <Box ml={'10%'} mr={'10%'} h='600px'>
        <Grid templateRows='repeat(7, 1fr)' templateColumns='repeat(8, 1fr)' gap='10px' className="align-items-center">
          <GridItem colSpan={4}>
            <TrackVisibility>
              {({ isVisible }) =>
            ...
            <TrackVisibility>
              {({ isVisible }) =>
                ...
                <form onSubmit={handleSubmit}>
                  <Grid templateRows='repeat(7, 1fr)' templateColumns='repeat(4, 1fr)' gap='7px'>
