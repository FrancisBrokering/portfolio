                ...
                <div className="row">
                    <div className="col-12">
                        <div className="skill-bx wow zoomIn">
                            <h2>Skills</h2>
                            <p>Here are programming languages and frameworks I've used for internships, assignments, and personal projects.
                                <br/>Some may need brushup since I haven't used them in a while</p>
